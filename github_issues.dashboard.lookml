- dashboard: github_issues
  ...
  - title: Avg Open Duration by Month
    ...
    explore: issue
    type: looker_area
    fields: [issue.created_month, issue.avg_open_duration]
    fill_fields: [issue.created_month]
  ...
  - title: Closed Issues Heatmap
    ...
    conditional_formatting: [{type: along a scale..., value: !!null '', background_color: "#FCCF41",
        font_color: !!null '', color_application: {collection_id: 1297ec12-86a5-4ae0-9dfc-82de70b3806a,
          palette_id: f29a5dfe-5665-4644-be18-468392d6af10, options: {steps: 5, constraints: {
              min: {type: minimum}, mid: {type: number, value: 0}, max: {type: maximum}},
            mirror: true, reverse: false, stepped: false}}, bold: false, italic: false,
        strikethrough: false, fields: [issue.count]}]
  ...
  - title: Issues with Most Mentions
    ...
    explore: issue
    type: looker_grid
    fields: [issue_mention.count, issue.title, issue.created_date, issue.id]
    sorts: [issue_mention.count desc]
    limit: 15
    query_timezone: America/Los_Angeles
    color_application:
  ...
  - title: Issues with Most Comments
    ...
    explore: issue
    type: looker_grid
    fields: [issue_comment.count, issue.title, issue.created_date, issue.id]
